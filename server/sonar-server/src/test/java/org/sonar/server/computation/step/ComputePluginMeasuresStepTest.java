...
public class ComputePluginMeasuresStepTest {
  ...
  public void compute_plugin_measure() throws Exception {
    ...
    ComputationStep underTest = new ComputePluginMeasuresStep(treeRootHolder, metricRepository, measureRepository, null, providers);
    underTest.execute();
  ...
  public class NewMeasureComputerProvider implements MeasureComputerProvider {
    @Override
