 ...
 * <p/>
 * This class is stateless. It does not keep pointers to classloaders and {@link SonarPlugin}.
 */
public class PluginLoader {
  ...
  /**
   * Instantiates collection of ({@link SonarPlugin} according to given metadata and classloaders
   *
