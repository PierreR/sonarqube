...
/**
 * This is the first entry point to declare how to compute measure for some given metrics.
 */
@ServerSide
@ExtensionPoint
public interface MeasureComputerProvider {
  ...
  interface Context {
     ...
     *
     * @throws UnsupportedOperationException when trying to add a computer providing some measures on metrics already defined by another plugin
     */
